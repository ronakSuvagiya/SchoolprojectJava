...
<body
						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item active open">
								<a href="#" class="nav-link nav-toggle"> <i class="material-icons">school</i>
									<span class="title">Attendance</span> <span class="selected"></span> <span class="arrow"></span>
                                    ...
                                    <div class="form-row">
										 ...
										 <div class="form-row">
											<div class="form-group col-md-6">
												...
												<label for="inputCity"> Date</label> <input
													class="form-control" name="collectionDate" type="text"
													id="dateOfBirth" placeholder="Date">
												
											</div>
											<div class="form-group col-md-6">
												<label>Enter Roll Number</label> 
												<input size="27" type="text" name="rollno" class="tags tags-input" data-type="tags"/>
											</div>
										</div>
    ...
    $("#list2").change(function(){
		...
		$.ajax({url: "http://quickedu.co.in/findByStdID?std="+$(this).val()+"&school=<c:out value='${school}'></c:out>", 
