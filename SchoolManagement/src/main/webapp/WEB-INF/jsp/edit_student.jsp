...
<body
									...
									<form action="/edit_stu" method="post">
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Roll No</label> <input type="text"
													...
													placeholder="ROll No" required="required" value="${student.rollNo }">
													<input name="oldrollno" type="hidden" id="txtRollNo"  value="${student.rollNo }">
											</div>
											<div class="form-group col-md-6">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Last Name</label> <input type="text"
													class="form-control" name="lastName" value="${student.lastName }"
													placeholder="Last Name" required="required">
											</div>
											<div class="form-group col-md-6">
											<input name="oldstd" class="mdl-textfield__input" type="hidden" value="${student.std.stdName}" readonly
												tabIndex="-1">
												<label>Department</label> <select
													class="custom-select mr-sm-2" name="std"
													required="required" id="list2">
													<option hidden
														value="${student.std.stdName}" selected>${student.std.stdName}</option>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Div</label> <select
													...
													<option value="${student.divId.name }" selected>${student.divId.name }</option>
												</select>
											</div>
											<div class="form-group col-md-6">
												<label>Gender</label> <select class="custom-select mr-sm-2"
													...
													<option hidden value="${student.gender }" selected>${student.gender }</option>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<textarea name="address" name="address" placeholder="address" class="form-control" rows="4" id="text7">${student.address }</textarea> 
											</div>
											<div class="form-group col-md-6">
												<label for="inputCity">Birth Date</label> <input
													class="form-control" name="dob" type="text"
													id="dateOfBirth" placeholder="Birth Date" value="${student.dob }">
											</div>
	...
	$("#list2").change(function(){
		...
		$.ajax({url: "http://ec2-35-173-199-33.compute-1.amazonaws.com:8080/findByStd?std="+$(this).val()+"&school=<c:out value='${school}'></c:out>", 
