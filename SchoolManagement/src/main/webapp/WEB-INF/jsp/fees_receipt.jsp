						...
						<ul class="sidemenu  page-header-fixed slimscroll-style"
							...
							<li class="nav-item active open"><a href="#"
								...
								<ul class="sub-menu">
									...
									<li class="nav-item active"><a href="fees_receipt"
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="white-box">
								<h3>
									<b>INVOICE</b> <span class="pull-right"></span>
								</h3>
								<hr>
								<div class="row">
									<div class="col-md-12">
										...
										<div class="pull-right text-right">
											<address>
												...
												<p class="font-bold addr-font-h4">${student.name}
													${student.lastName}</p>
												<p class="m-t-30">

													<b>Invoice Date :</b> <i class="fa fa-calendar"></i> ${date }
												</p>
												<p>
													<b>Course :</b> ${student.std.stdName} ${student.divId.name }
												</p>
											</address>
										</div>
									</div>
									<div class="col-md-12">
										<div class="table-responsive m-t-40">
											<table class="table table-hover">
												...
												<tbody>
													<c:choose>
														<c:when test="${not empty feeDeatils }">
															<c:forEach items="${feeDeatils }" var="fee"
																varStatus="loop">
																<tr>
																	<td class="text-center">${loop.index + 1}</td>
																	<td class="text-left">${fee.deatils }</td>
																	<td class="text-right">${fee.date }</td>
														...
														<c:otherwise>
																<tr>
																	...
																	<td class="text-left">All Receipt Are Printed</td>
									...
									<div class="col-md-12">
										<div class="pull-right m-t-30 text-right">
											<p>
												Sub - Total amount:
												<c:out value="${amount}">${amount}</c:out>
											</p>
											<hr>
											<h3>
												<b>Total :</b>
