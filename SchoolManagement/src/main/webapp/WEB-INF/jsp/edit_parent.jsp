				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Parent</div>
							</div>
						...
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body" id="bar-parent2">
									<form action="/edit_pnt" method="post">
										<div class="form-row">
											
											<div class="form-group col-md-6">
												<label>First Name</label> <input type="text" name="name"
													class="form-control" placeholder="First Name" value="${parent.name }"
													required="required">
											</div>
											<div class="form-group col-md-6">
												<label>Last Name</label> <input type="text"
													class="form-control" name="lastName" value="${parent.lastName }"
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="inputCity">MobileNo</label> <input type="number" value="${parent.mobileNo }"
													name="mobileNo" class="form-control"
													placeholder="Mobile No">
											</div>
											<div class="form-group col-md-6">
												<label>Email Id</label> <input type="email" name="emialID" value="${parent.emialID }"
										...
										<div class="form-group col-md-4">
												...
												<input type="text" value="${parent.stu.std.stdName }"
													 class="form-control"
											...
											<div class="form-group col-md-4">
												<label>Student Div</label> 
												<input type="text" value="${parent.stu.divId.name }"
													 class="form-control"
													placeholder="Mobile No" readonly="readonly">
											...
											<div class="form-group col-md-4">
												...
												<input type="text" value="${parent.stu.name }"
												 class="form-control"
													placeholder="Mobile No" readonly="readonly">
													<input type="hidden" name="stu" value="${parent.stu.id}">
											</div>
										</div>
										<br>
