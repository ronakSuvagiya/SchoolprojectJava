							...
							<div class="card-box">
								...
								<div class="card-body ">
									<div id="external-events">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Start Date</label> <input
													class="form-control" name="startDate" type="text"
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Event Title</label> <input type="text" value="" class="form-control"
												placeholder="Event Title..." name="title" />
											</div>

											<div class="form-group col-md-6">
												<label>Start Time</label> <input
													class="form-control" name="startTime" type="text"
													id="time" placeholder="Start Time">
											</div>
										</div>
