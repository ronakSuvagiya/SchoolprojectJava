				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Holiday</div>
							</div>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label>Date</label> <input
													class="form-control" name="date" type="text"
													id="dateOfBirth" placeholder="Start Date">
											</div>

										<div class="form-group col-md-6">
												<label>Title</label> <input type="text" value="" class="form-control"
												placeholder="Holiday Title..." name="Desc" />
											</div>
										</div>
											<br />
