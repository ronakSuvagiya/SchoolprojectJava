						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									...
									<li class="nav-item">
										<a href="add_attendancel" class="nav-link "> <span class="title">Add
												Course</span>
										</a>
									</li>
				...
				<div class="page-content">
									...
									<form action="addStd" method="post">
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label>Std Name</label> <input type="text" name="Stdname"
													class="form-control" placeholder="Std Name"
													required="required">
											</div>
											<div class="form-group col-md-6">
												<label>Fees Amount</label> <input type="text" name="fee"
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Add Div</header>
									
								</div>
								<div class="card-body" id="bar-parent2">
									<form action="/adddivs" method="post">
										<div class="form-row">
											<div class="form-group col-md-6">
											...
											<div class="form-group col-md-6">
												<label>Div Name</label> <input type="text" name="DivName"
													class="form-control" placeholder="Div Name"
													required="required">
											</div>
