...
<body
						...
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body" id="bar-parent2">
									<form action="/add_pnt" method="post">
										<div class="form-row">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label>Email Id</label> <input type="email" name="emialID"
										...
										<div class="form-group col-md-4">
											...
											<div class="form-group col-md-4">
												<label>Student Name</label> <select
	...
	$("#divElement").change(function(){
		
		$('#studentName').find('option').remove();
		$.ajax({url: "http://quickedu.co.in/findByStdAndDiv?std="+ $("#list2").val() +"&div="+$(this).val(), 
			success: function(result){
				for(var i =0; i<result.length;i++)
					{
					  var node = document.createElement("option");
					  node.setAttribute("value",result[i].id);
					  var textnode = document.createTextNode(result[i].name +" "+result[i].lastName);
	...
	function abc()
	{
		...
		$.ajax({url: "http://quickedu.co.in/findByStdAndDiv?std="+ $("#list2").val() +"&div="+myOpts[0].value, 
			success: function(result){
				for(var i =0; i<result.length;i++)
					{
					  var node = document.createElement("option");
	...
	$("#list2").change(function(){
		...
		$.ajax({url: "http://quickedu.co.in/findByStdID?std="+$(this).val(), 
			success: function(result){
				for(var i =0; i<result.length;i++)
					{
					  var node = document.createElement("option");
